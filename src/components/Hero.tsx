      ...
      <div className="container max-w-5xl mx-auto px-4">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-6 md:mt-8">
            <StaggeredText
              ...
              el="h1"
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-medium text-center"
              once={true}
            />
          </div>
          ...
          <motion.p
            className="text-center text-base sm:text-lg md:text-xl text-white/70 mt-8 sm:mt-10 md:mt-12 max-w-2xl mx-auto px-4"
        ...
        >
          <div className="flex w-full max-w-xs sm:max-w-sm md:max-w-md mx-4">
            <Input
              ...
              className="bg-black/50 border-white/10 rounded-l-full rounded-r-none focus-visible:ring-0 focus-visible:ring-offset-0 h-10 md:h-12 text-sm md:text-base"
            />
            <Button className="rounded-r-full rounded-l-none bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 h-10 md:h-12 text-sm md:text-base">
              Get Started
            </Button>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <span className="text-white/70 text-sm md:text-base">YouTube Integration</span>
          </motion.div>
          <motion.div
            className="flex items-center gap-2"
          ...
          >
            ...
            <span className="text-white/70 text-sm md:text-base">Spotify Integration</span>
          </motion.div>
          <motion.div
            className="flex items-center gap-2"
            initial={{ x: 50, opacity: 0 }}
          ...
          >
            ...
            <span className="text-white/70 text-sm md:text-base">Real-time Chat</span>
          </motion.div>
        </motion.div>
      </div>
    </section>
